...
const CouponManagement = () => {
  ...
  return (
    <div className="p-6 max-w-5xl mx-auto">
      <h1 className="text-2xl font-bold text-blue-800 mb-6">Coupon Management</h1>
      ...
      >
        ...
        <div className="md:col-span-2 flex gap-3">
          <button
            type="submit"
            disabled={loading}
            className="px-6 py-2 bg-blue-700 text-white rounded hover:bg-blue-800 font-semibold"
          >
