...
const calculatePricing = ({ baseAmount, participantCategory, hasMembership, hasCoupon }) => {
  ...
  if (hasMembership && hasCoupon) {
    // Both: 10% off registration fee, plus membership fee
    ...
    // Only membership: 5% off, plus membership fee
    calc.membershipDiscount = base * 0.05;
  ...
  const HandleRegistration = async (e) => {
    ...
    try {
      ...
      const options = {
        ...
        theme: { color: "#1e3a8a" }, // blue-900 to match APCEESH theme
        modal: {
          ondismiss: async () => {
            try {
  ...
  return (
    <div>
      ...
      <section className="pt-10 md:pt-2">
        ...
        <div
          data-aos="fade-up"
          className="flex flex-col justify-center items-center text-center mt-5 space-y-4"
        >
        ...
        <div data-aos="fade-up" className="flex flex-col justify-center items-center mt-10 p-5 md:py-0">
          ...
          >
            ...
            <section className="w-full space-y-4 md:columns-2 gap-5" data-aos="fade-up">
              ...
              <div>
                <input type="text" name="first_name" className="w-full p-2.5 border border-gray-300 outline-none rounded-md" placeholder="First Name" required />
              </div>
              <div>
                <input type="text" name="last_name" className="w-full p-2.5 border border-gray-300 outline-none rounded-md" placeholder="Last Name" required />
              </div>
              <div>
                <input type="text" name="certificate_name" className="w-full p-2.5 border border-gray-300 outline-none rounded-md" placeholder="Certificate Name" required />
              </div>
              <div>
              ...
              <div>
                <input type="text" name="nationality" className="w-full p-2.5 border border-gray-300 outline-none rounded-md" placeholder="Nationality" required />
              </div>
              <div>
                <input type="text" name="department" className="w-full p-2.5 border border-gray-300 outline-none rounded-md" placeholder="Department" required />
              </div>
              <div>
                <input type="text" name="institution" className="w-full p-2.5 border border-gray-300 outline-none rounded-md" placeholder="Institution" required />
              </div>
              <div>
                <input type="tel" name="number" className="w-full p-2.5 border border-gray-300 outline-none rounded-md" placeholder="Mobile Number with Country Code" required />
              </div>
              <div>
                <input type="email" name="email" className="w-full p-2.5 border border-gray-300 outline-none rounded-md" placeholder="E-mail" required />
              </div>

              {/* Participant Category — drives membership fee tier */}
              <div>
                <select
                  className="w-full p-2.5 border border-gray-300 outline-none rounded-md"
