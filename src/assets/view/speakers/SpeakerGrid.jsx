...
const ROLE_COLORS = {
  "Welcome Address": "text-blue-800",
  "Guest of Honour": "text-blue-800",
  "Conference Chair": "text-blue-800",
  "Keynote Speakers": "text-blue-800",
  "Session Speakers": "text-blue-800",
  "Session Chairs": "text-blue-800",
};

const BADGE_COLORS = {
  "Welcome Address": "bg-blue-50 text-blue-700 border border-blue-200",
  "Guest of Honour": "bg-blue-50 text-blue-700 border border-blue-200",
  "Conference Chair": "bg-blue-50 text-blue-700 border border-blue-200",
  "Keynote Speakers": "bg-blue-50 text-blue-700 border border-blue-200",
