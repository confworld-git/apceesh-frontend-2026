...
export default function ConferenceCarousel() {
  ...
  const publications = [
    ...
    },
    {
      ...
      authors: "Rumpa Neogi, Arnab Bhattacharjee, Tanushree Biswas",
      publication: "Human Arenas",
      year: "2026",
      pages: "",
    },
  ...
  return (
    <div className="min-h-screen bg-blue-100 flex flex-col items-center justify-center p-8 ">
      ...
      <div className="max-w-6xl w-full relative">
        {/* Card */}
        <div className="bg-whitereg rounded-2xl shadow-2xl p-12 min-h-[400px] flex flex-col justify-center transition-all duration-500">
      ...
      <div className="max-w-6xl w-full mt-8 text-center">
        <p className="text-2xl text-gray-800 font-semibold">
          Join us at APCEESH and unlock the opportunity to publish your research in reputed <br/>Scopus / SCIE indexed journals.
        </p>
      </div>
    </div>
  );
