            ...
            <div className="space-y-4 py-4 lg:py-8">
              ...
              <div className="flex justify-center lg:justify-end py-6 lg:py-0">
                <div className="relative w-full max-w-lg lg:max-w-none">
                  {/* Mobile Video */}
                  <div className="lg:hidden w-full aspect-video overflow-hidden rounded-xl border-4 border-blue-800 shadow-lg">
                    <video
                      src="/videos/healthcare-conference-2026-highlights.webm"
                  ...
                  <div className="hidden py-12 lg:block w-full h-[500px] mx-auto">
                    <div className="w-full h-full bg-gradient-to-br from-blue-800 to-blue-900 rounded-2xl shadow-2xl p-1">
                      <div className="w-full h-full bg-blue-900 overflow-hidden ring-4 ring-amber-400 ring-offset-2 ring-offset-blue-800">
                        <video
                          src="/videos/healthcare-conference-2026-highlights.webm"
                          className="w-full h-full object-cover"
                          autoPlay
