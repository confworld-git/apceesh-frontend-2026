    ...
    <div className="min-h-screen flex flex-col">
      ...
      <div className="fixed bottom-6 right-6 flex flex-col gap-3 z-50">
        ...
        <a
          ...
          className="bg-blue-800 hover:bg-blue-700 text-white hover:text-amber-400 px-4 py-3 rounded-full shadow-lg text-sm font-semibold transition-all duration-300"
        >
          Submit Paper
        </a>
